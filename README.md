...
```
sfive/
├── index.php                  ← Homepage (cottages with thumbnails + availability)
├── cottage.php                ← Cottage detail page (photo gallery + lightbox)
├── booking.php                ← Reservation form + PayMongo GCash payment
├── check_booking.php          ← Guest booking lookup
├── paymongo_webhook.php       ← PayMongo payment event receiver
├── database.sql               ← Run this first in MySQL
│
├── admin/
│   ├── login.php              ← Admin login
│   ├── index.php              ← Dashboard (stats + chart)
│   ├── reservations.php       ← Manage bookings (approve/reject)
│   ├── cottages.php           ← Add/edit/delete cottages
│   ├── guests.php             ← Guest records
│   ├── reports.php            ← Monthly revenue reports (printable)
│   ├── gcash.php              ← GCash payment verification
│   ├── logout.php
...
│
├── includes/
│   ├── config.php             ← DB + PayMongo keys
│   └── paymongo.php           ← PayMongo API functions
│
├── css/
│   ├── style.css              ← Main frontend styles
│   └── cottage.css            ← Cottage detail + lightbox styles
│
├── js/
│   └── main.js
│
├── images/
│   └── cottage_placeholder.php ← Auto-generates SVG thumbnails per cottage
│
├── uploads/                   ← GCash proof uploads (if manual)
└── logs/
    └── webhook.log            ← PayMongo webhook event log
```
