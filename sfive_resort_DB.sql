-- S-Five Inland Resort — clean fresh install dump
...
ALTER TABLE `cottages` AUTO_INCREMENT = 13;
...
CREATE TABLE `cottage_images` (
  ...
  PRIMARY KEY (`id`),
  KEY `cottage_id` (`cottage_id`),
  CONSTRAINT `cottage_images_ibfk_1` FOREIGN KEY (`cottage_id`) REFERENCES `cottages` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
ALTER TABLE `cottage_images` AUTO_INCREMENT = 13;
...
CREATE TABLE `reservations` (
  ...
  KEY `cottage_id` (`cottage_id`),
  CONSTRAINT `reservations_ibfk_1` FOREIGN KEY (`cottage_id`) REFERENCES `cottages` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `gcash_payments` (
  ...
  CONSTRAINT `gcash_payments_ibfk_1` FOREIGN KEY (`reservation_id`) REFERENCES `reservations` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `gcash_payments` AUTO_INCREMENT = 16;
...
ALTER TABLE `gcash_settings` AUTO_INCREMENT = 2;
