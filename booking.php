...
<<<<<<< HEAD
                                ...
                                <div class="gcash-account-box" style="background:#f0fdf6;border:1.5px dashed #a3cfbb;border-radius:8px;padding:0.9rem 1rem;margin:0.5rem 0;text-align:center;">
                                    ...
                                    <img src="<?= htmlspecialchars($gcash_qr_url) ?>" alt="GCash QR Code"
                                         style="max-width:180px;width:100%;border-radius:8px;background:#fff;padding:0.4rem;border:1px solid #d7ead9;">
                                    <?php else: ?>
                                    <div style="font-size:0.8rem;color:#888;padding:1rem 0;">QR code coming soon — please contact the resort for GCash payment details.</div>
                                    <?php endif; ?>
                                    <div style="font-size:0.78rem;color:#5a8a6f;font-weight:700;text-transform:uppercase;margin-top:0.6rem;">GCash Account</div>
                                    <div style="font-size:1.05rem;font-weight:700;color:#0a5c36;"><?= htmlspecialchars($gcash_settings['account_name']) ?></div>
                                </div>
                                <ol start="2">
...
<<<<<<< HEAD
                        ...
                        <div class="qr-placeholder" style="padding:0.75rem;">
                            <img src="<?= htmlspecialchars($gcash_qr_url) ?>" alt="GCash QR Code"
                                 style="max-width:130px;width:100%;border-radius:6px;background:#fff;">
                            <p style="margin-top:0.5rem;">Scan to Pay</p>
